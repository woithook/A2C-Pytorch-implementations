...
version: 0.2
Use the discounted reward sum as an approximation of value Q
Modified

Performance: It does work! Strange.
"""
...
def A2C(net, optimizer, buff):
    ...
    for i in range(len(buff)):
        ...
        A_s_a = Q_s_a - V_s
        A_s_a = (A_s_a - A_s_a.mean()) / (A_s_a.std() + torch.finfo(torch.float32).eps)
